...
public class FuncionarioTest {
	...
	public void criar_antes_de_todos_os_testes() {
		funcionarioBefore = new Funcionario(NOME,CPF,DATA_NASCIMENTO,CARGO);
	...
	public void testA_deve_criar_um_funcionario_com_o_nome_valido() {
		assertSame(funcionarioBefore.getNomeCompleto(),new Funcionario(NOME,CPF,DATA_NASCIMENTO,CARGO).getNomeCompleto());
	}
	
	@Test(expected = IllegalStateException.class)
	public void testB_nao_deve_criar_funcionario_com_o_nome_menor_que_5_caracteres() {
		new Funcionario("Jose",CPF,DATA_NASCIMENTO,CARGO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void testC_nao_deve_criar_funcionario_com_o_nome_maior_que_60_caracteres() {
		new Funcionario("Jose jose jose jose jose jose jose jose jose jose jose jose jose",CPF,DATA_NASCIMENTO,CARGO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void testD_nao_deve_criar_funcionario_com_o_nome_vazio() {
		new Funcionario("",CPF,DATA_NASCIMENTO,CARGO);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testE_nao_deve_criar_funcionario_com_o_nome_nulo() {
		new Funcionario(null,CPF,DATA_NASCIMENTO,CARGO);
	}
	
	@Test(expected = IllegalStateException.class)
	public void testB_nao_deve_settar_funcionario_com_o_nome_menor_que_5_caracteres() {
		funcionarioBefore.setNomeCompleto("Jose");
	}
	
	@Test(expected = IllegalStateException.class)
	public void testC_nao_deve_settar_funcionario_com_o_nome_maior_que_60_caracteres() {
		funcionarioBefore.setNomeCompleto("Jose jose jose jose jose jose jose jose jose jose jose jose jose");
	}
	
	@Test(expected = IllegalStateException.class)
	public void testD_nao_deve_settar_funcionario_com_o_nome_vazio() {
		funcionarioBefore.setNomeCompleto("");
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testE_nao_deve_settar_funcionario_com_o_nome_nulo() {
	...
	public void testO_deve_criar_funcionario_com_cpf_valido() {
		...
		assertSame(CPF_2,new Funcionario(NOME,CPF_2,DATA_NASCIMENTO,CARGO).getCpf());
	}
	...
	public void testR_nao_deve_criar_funcionario_com_data_de_nascimento_nulo() {
		new Funcionario(NOME,CPF,null,CARGO);
	}
	...
	public void testV_deve_criar_funcionario_com_data_de_nascimento_maior_que_18() {
		...
		assertEquals(DATA_NASCIMENTO_3,new Funcionario(NOME,CPF,DATA_NASCIMENTO_3,CARGO).getDataNascimento());
	}
	...
	@Test(expected = IllegalStateException.class)
	public void testY_nao_deve_criar_funcionario_com_o_cargo_menor_que_5_caracteres() {
		new Funcionario(NOME,CPF,DATA_NASCIMENTO,"SEM");
	}
	
	@Test(expected = IllegalStateException.class)
	public void testZ_nao_deve_criar_funcionario_com_o_cargo_maior_que_60_caracteres() {
		new Funcionario(NOME,CPF,DATA_NASCIMENTO,"Possui mais de sessenta caracteres Possui mais de sessenta caracteres");
	}
	
	@Test(expected = IllegalStateException.class)
	public void testAA_nao_deve_criar_funcionario_com_o_cargo_contendo_numeros() {
		new Funcionario(NOME,CPF,DATA_NASCIMENTO,"Analista 2");
	}
	
	@Test(expected = IllegalStateException.class)
	public void testAB_nao_deve_criar_funcionario_com_o_cargo_vazio() {
		new Funcionario(NOME,CPF,DATA_NASCIMENTO,"");
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testAC_nao_deve_criar_funcionario_com_o_cargo_nulo() {
		new Funcionario(NOME,CPF,DATA_NASCIMENTO,null);
	}
	...
	public void testAF_nao_deve_retornar_igualdade_ao_comparar_funcionarios_com_atributos_diferentes() {
		assertNotEquals(funcionarioBefore, new Funcionario(NOME,"24783928010",DATA_NASCIMENTO,CARGO));
	}
	...
	public void testAH_deve_retornar_igualdade_ao_comparar_funcionarios_com_mesmos_atributos() {
		assertEquals(funcionarioBefore,new Funcionario(NOME,CPF,DATA_NASCIMENTO,CARGO));
	}
	...
	public void testAK_nao_deve_retornar_igualdade_no_hashcode_ao_comparar_funcionarios_diferentes() {
		assertNotEquals(funcionarioBefore.hashCode(),new Funcionario(NOME,"24783928010",DATA_NASCIMENTO,CARGO).hashCode());
	}
