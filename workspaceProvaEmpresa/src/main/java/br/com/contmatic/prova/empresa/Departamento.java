...
import static br.com.contmatic.prova.util.ValidatorUtil.validarCaracteresLetrasNumerosAcentos;
...
public class Departamento extends Auditoria {
    ...
    public void setCodigo(String codigo) {
        ...
        validarCaracteresLetrasNumerosAcentos(codigo, CODIGO_NAO_PODE_CONTER_CARACTERES_ESPECIAIS);
        this.codigo = codigo;
    }
