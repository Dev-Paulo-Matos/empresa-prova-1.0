...
public final class EnderecoConstantes {
	...
	public static final int NUMERO_MENOR_QUE_1 = 0;
	...
	public static final String CEP_NAO_PODE_POSSUIR_UM_VALOR_SEQUENCIAL = "CEP não pode possuir um valor sequencial!";
	public static final String NUMERO_NAO_PODE_ESTAR_VAZIO = "Numero não pode estar vazio!";
	...
	public static final String BAIRRO_NAO_PODE_SER_MENOR_QUE_3_E_MAIOR_QUE_60_CARACTERES = "Bairro não pode ser menor que 3 e maior que 60 caracteres";
