...
public class Empresa extends Auditoria {
    ...
    public void setRazaoSocial(String razaoSocial) {
        ...
        validarCaracteresLetrasNumerosEspacosAcentos(razaoSocial, RAZAO_SOCIAL_NAO_PODE_CONTER_CARACTERES_ESPECIAIS);
    ...
    public void setNomeFantasia(String nomeFantasia) {
        ...
        validarCaracteresLetrasNumerosEspacosAcentos(nomeFantasia, NOME_FANTASIA_NAO_PODE_CONTER_CARACTERES_ESPECIAIS);
